// <copyright file="DataReader.cs" company="BakuninCompany">
...
namespace DAL.Helpers
{
    ...
    internal class DataReader
    {
        ...
        public static void PrintUsers(NpgsqlConnection connection)
        {
            ...
            while (rdr.Read())
            {
                Console.WriteLine("{0,-4}    |    {1,-25}    |    {2,-25}", rdr.GetInt32(0), rdr.GetString(1), rdr.GetString(2));
            }
        ...
        public static void PrintBooks(NpgsqlConnection connection)
        {
            ...
            Console.WriteLine("{0,-5}    |    {1,-18}    |    {2,-12}    |    {3,-10}\n", rdrb.GetName(0), rdrb.GetName(1), rdrb.GetName(2), rdrb.GetName(3));

            while (rdrb.Read())
            {
                Console.WriteLine("{0,-5}    |    {1,-18}    |    {2,-12}    |    {3,-10}", rdrb.GetInt32(0), rdrb.GetString(1), rdrb.GetString(2), rdrb.GetInt32(3));
            }
        ...
        public static void PrintStatistic(NpgsqlConnection connection)
        {
            ...
            Console.WriteLine("{0,-8}    |    {1,-8}    |    {2,-8}    |    {3,-15}    |    {4,-6}\n", rdrs.GetName(0), rdrs.GetName(1), rdrs.GetName(2), rdrs.GetName(3), rdrs.GetName(4));

            while (rdrs.Read())
            {
                Console.WriteLine("{0,-8}    |    {1,-8}    |    {2,-8}    |    {3,-15}    |    {4,-6}...", rdrs.GetInt32(0), rdrs.GetInt32(1), rdrs.GetInt32(2), rdrs.GetInt32(3), rdrs.GetString(4).Substring(0, rdrs.GetString(4).Length / 20));
            }
